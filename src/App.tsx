...
export function App() {
  ...
  return (
    <div
      id="main"
      className="w-screen h-screen flex flex-col gap-8 justify-center items-center lg:p-10 lg:pb-4"
    >
      <div className="max-w-[900px] card w-full h-full bg-base-100 shadow-xl">
        <div className="card-body grow overflow-hidden">
          <ChatHeader />
      ...
      <div className="flex gap-4">
        <a
          ...
          role="button" className="btn btn-sm btn-outline w-max uppercase"
        >
