  ...
  return (
    <div className="flex gap-4">
      ...
      >
        ...
        <span className="hidden lg:inline">View code</span><span className="lg:hidden">Code</span>
      </a>
      <a
      ...
      >
        ...
        <span className="hidden lg:inline">Deploy to Netlify</span><span className="lg:hidden">Deploy</span>
